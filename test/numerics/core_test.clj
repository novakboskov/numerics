...
(deftest underd-pseudo-inverse-test
  (testing "underd-pseudo-inverse method testing."
    ...
    (is (=
         (underd-pseudo-inverse [[0.0077 0.0006 -0.3] [0.1258 0.0085 -0.4] [0.0994 0.8111 -0.3]] [-0.499 -0.08 -0.03])
...
(deftest overd-pseudo-inverse-test
  (testing "overd-pseudo-inverse testing"
    ...
    (is (=
         (overd-pseudo-inverse [[0.0077 -0.3] [0.1258 -0.4] [0.0994 -0.3]] [-0.499 -0.085 -0.039])
